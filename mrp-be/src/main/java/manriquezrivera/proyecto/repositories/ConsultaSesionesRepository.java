...
public interface ConsultaSesionesRepository extends JpaRepository<ConsultaSesiones, Long> {
	...
	@Query(value = "SELECT s.id as id,s.fecha as fecha, s.tiempo as tiempo FROM sesion as s, caso_abogado as ca, caso as c WHERE ca.id_abogado = :id_abogado AND ca.id_abogado = s.id_abogado AND s.id_caso = :id_caso AND s.borrado = 0 AND c.id = :id_caso AND s.id_caso = ca.id_caso AND s.fecha BETWEEN :fechaInicio AND :fechaFin ORDER BY s.fecha ASC", nativeQuery = true)
	...
	@Query(value = "SELECT sesion.id, sesion.fecha, sesion.tiempo FROM caso, sesion WHERE caso.id = :id_caso AND sesion.id_caso = caso.id AND sesion.borrado = 0 AND sesion.fecha BETWEEN :fechaInicio AND :fechaFin ORDER BY sesion.fecha ASC", nativeQuery = true)
	...
	@Query(value = "SELECT s.id as id,s.fecha as fecha, s.tiempo as tiempo FROM sesion as s, caso_abogado as ca, caso as c WHERE ca.id_abogado = :id_abogado AND ca.id_abogado = s.id_abogado AND s.id_caso = :id_caso AND s.borrado = 0 AND c.id = :id_caso AND s.id_caso = ca.id_caso ORDER BY s.fecha ASC", nativeQuery = true)
	...
	@Query(value = "SELECT s.id as id,s.fecha as fecha, s.tiempo as tiempo FROM sesion as s, caso as c WHERE s.id_caso = :id_caso AND s.borrado = 0 AND c.id = :id_caso ORDER BY s.fecha ASC", nativeQuery = true)
