                ...
                <div className='container2'>
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td className="special-column"><FaPlayCircle onClick={Play} style={{ color: "#DFBF68", fontSize: "35px" }} /></td>
                                <td className="special-column"><FaCirclePause onClick={Pause} style={{ color: "#DFBF68", fontSize: "35px" }} /></td>
                                <td>Joakin Roa</td>
                                <td>Familia</td>
                                <td>Pensión de alimentos</td>
                                <td className="special-column"><PiClockCountdownFill style={{ color: "#DFBF68", fontSize: "35px" }} /></td>
                            </tr>
                            <tr>
                                <td className="special-column"><FaPlayCircle onClick={Play} style={{ color: "#DFBF68", fontSize: "35px" }} /></td>
                                <td className="special-column"><FaCirclePause onClick={Pause} style={{ color: "#DFBF68", fontSize: "35px" }} /></td>
