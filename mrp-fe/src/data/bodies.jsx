...
const bodyCaso = (caso, edit, deleted) => {
  return (
    <tr key={caso.id} className="table-paginated-body__row">
      ...
      <td className="table-paginated-body__actions">
        <VscEdit onClick={() => edit(caso)} className="table-paginated-body__actions-item table-paginated-body__actions-item--edit" />
        <VscTrash onClick={() => deleted(caso)} className="table-paginated-body__actions-item table-paginated-body__actions-item--delete" />
      </td>
    </tr>
  );
};
...
const bodyMateria = (materia, edit, deleted) => {
  return (
    <tr key={materia.id} className="table-paginated-body__row">
      ...
      <td className="table-paginated-body__actions">
        <VscEdit onClick={() => edit(materia)} className="table-paginated-body__actions-item table-paginated-body__actions-item--edit" />
        <VscTrash onClick={() => deleted(materia)} className="table-paginated-body__actions-item table-paginated-body__actions-item--delete" />
      </td>
    </tr>
  );
};
...
const bodySubmateria = (submateria, edit, deleted) => {
  return (
    <tr key={submateria.id} className="table-paginated-body__row">
      ...
      <td className="table-paginated-body__actions">
        <VscEdit onClick={() => edit(submateria)} className="table-paginated-body__actions-item table-paginated-body__actions-item--edit" />
        <VscTrash onClick={() => deleted(submateria)} className="table-paginated-body__actions-item table-paginated-body__actions-item--delete" />
      </td>
    </tr>
  );
};
